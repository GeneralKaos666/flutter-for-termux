...
Default input tests the published 3.47.2 release asset:

```text
deb_url: https://github.com/GeneralKaos666/flutter-for-termux/releases/download/3.47.2/flutter_3.47.2_aarch64.deb
...
scripts/device/run_termux_smoke.ps1 `
  ...
  -DebUrl "https://github.com/GeneralKaos666/flutter-for-termux/releases/download/3.47.2/flutter_3.47.2_aarch64.deb"
```
