...
- **Drift Checks:** `check_version_drift.py` asserts complete consistency across `build.toml`, `package.yaml`, `README.md`, `README_ZH.md`, `BUILD_GUIDE.md`, `INSTALL_GUIDE.md`, and installer scripts.
