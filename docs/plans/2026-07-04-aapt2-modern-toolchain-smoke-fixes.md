...
# In scripts/device/run_termux_smoke.ps1, update default values in param block:
    [string]$DebUrl = "https://github.com/GeneralKaos666/flutter-for-termux/releases/download/v3.44.2-termux/flutter_3.44.2_aarch64.deb",
...
# In .github/workflows/device-smoke.yml, update defaults:
      deb_url:
        ...
        required: true
        default: https://github.com/GeneralKaos666/flutter-for-termux/releases/download/v3.44.2-termux/flutter_3.44.2_aarch64.deb
      expected_sha256:
