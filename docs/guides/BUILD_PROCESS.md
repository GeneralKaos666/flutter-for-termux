...
Output: `release/flutter_3.47.5-1_aarch64.deb`
...
adb push flutter_3.47.5-1_aarch64.deb /sdcard/Download/

# 2. Install it in Termux
pkg install x11-repo
dpkg -i /sdcard/Download/flutter_3.47.5-1_aarch64.deb
...
2. Upload the deb file: `flutter_3.47.5-1_aarch64.deb`
