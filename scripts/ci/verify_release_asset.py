...
def main():
    ...
    if expected_asset is None:
        print("Error: Missing release_tag/tag and asset_name in build.toml")
        sys.exit(1)
    ...
    if expected_sha256:
        ...
        print("Manifest has no sha256 declared; skipping checksum verification.")
    ...
    repo = os.environ.get("GITHUB_REPOSITORY", "GeneralKaos666/flutter-for-termux")
