<p align="center">
  <img src="assets/banner.png" alt="flutter-for-termux" width="800"/>
</p>
...
| Release asset | [`flutter_3.47.2_aarch64.deb`](https://github.com/GeneralKaos666/flutter-for-termux/releases/tag/3.47.2) |
...
pkg install -y curl
curl -L https://raw.githubusercontent.com/GeneralKaos666/flutter-for-termux/main/install_flutter_complete.sh -o install_flutter_complete.sh
...
│   ├── guides/               # 安裝、構建、升級指南（英文版 + *_ZH.md 中文版）
...
每一份指南都有中文版（例如 `docs/guides/BUILD_GUIDE_ZH.md`），可在文件頂部的語言切換列找到。
...
- `build()` 的 ninja 調用包含 `flutter/build/archives:dart_sdk_archive`、`flutter_patched_sdk` 與 `flutter_gtk`；dart 二進制隨標準構建產出，無需額外步驟。
